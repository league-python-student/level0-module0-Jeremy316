...
if __name__ == '__main__':
    ...
    messagebox.showinfo(title='', message=prompt)
    # Get the player to enter an adjective
    Adjective = simpledialog.askstring(None, prompt= "Type an adjective")
    # Get the player to enter a type of liquid
    Liquid = simpledialog.askstring(None, prompt= "Type a Liquid")
    # Get the player to enter a body part
    Body = simpledialog.askstring(None, prompt= "Type a Body Part")
    # Get the player to enter a verb
    Verb = simpledialog.askstring(None, prompt= "Type a Verb")
    # Get the player to enter a place
    Place = simpledialog.askstring(None, prompt= "Type a Place")
